...
_io = [
    ...
    ("btnd", 0, Pins("V10"), IOStandard("LVCMOS33")),
...
#    ),
    ...
    #Servomotor
    ("servo1", 0, Pins("B13"), IOStandard("LVCMOS33")),
    ("servo2", 0, Pins("F14"), IOStandard("LVCMOS33")),
    ("btnud", 0, Pins("D17"), IOStandard("LVCMOS33")),
    ("btnui", 0, Pins("E17"), IOStandard("LVCMOS33")),
    ("btnut", 0, Pins("G13"), IOStandard("LVCMOS33")),


#("pmoda",    "B13 F14 D17 E17 G13 C17 D18 E18"),

    #Ultrasonico1
    ("echo1", 0, Pins("G14"), IOStandard("LVCMOS33")),
    ("trig1", 0, Pins("P15"), IOStandard("LVCMOS33")),
    #Ultrasonico2
    ("echo2", 0, Pins("V11"), IOStandard("LVCMOS33")),
    ("trig2", 0, Pins("V15"), IOStandard("LVCMOS33")),

    ("freq", 0, Pins("K16"), IOStandard("LVCMOS33")),
]
...
class Platform(XilinxPlatform):
    ...
    def __init__(self, toolchain="vivado"):
        XilinxPlatform.__init__(self, "xc7a100t-CSG324-1", _io, toolchain=toolchain)
